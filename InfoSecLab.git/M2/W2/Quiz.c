...
//NOTA PER NIKO: non avendo le basi necessarie per poter sviluppare il progetto richiesto
// dall'esercio ho sfruttato l'aiuto dell'AI e di Microsoft. 
//Ho inserito i dati dell'esercio e premuto invio, il risultato è quanto segue. Il programma è stato testato e funziona perfettamente.

//COMMENTI PER NIKO
//E' inserito "stdlib.h" in quanto è l'header file che, all'interno della libreria standard del C, 
...
//time.h è l'header file della libreria di C e fornisce un accesso standardizzato alle funzioni di acquisizione e manipolazione
// del tempo.
